...
namespace AircraftService.Migrations
{
    ...
    [Migration("20241122054807_efter deletion")]
    partial class efterdeletion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AircraftService.Models.Entities.Aircraft", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cycles = 1500,
                            LastUpdated = new DateTime(2024, 11, 22, 5, 48, 7, 434, DateTimeKind.Utc).AddTicks(9732),
                            Model = "Boeing 737",
                            Registration = "N12345",
                        ...
                        new
                        {
                            ...
                            CurrentStatus = "AOG",
                            Cycles = 1200,
                            LastUpdated = new DateTime(2024, 11, 22, 5, 48, 7, 434, DateTimeKind.Utc).AddTicks(9738),
                            Model = "Airbus A320",
                            Registration = "G67890",
                        ...
                        new
                        {
                            ...
                            CurrentStatus = "Airworthy",
                            Cycles = 3000,
                            LastUpdated = new DateTime(2024, 11, 22, 5, 48, 7, 434, DateTimeKind.Utc).AddTicks(9740),
                            Model = "Boeing 747",
                            Registration = "D45678",
                        ...
                        new
                        {
                            ...
                            Cycles = 2000,
                            LastUpdated = new DateTime(2024, 11, 22, 5, 48, 7, 434, DateTimeKind.Utc).AddTicks(9742),
                            Model = "Airbus A380",
                            Registration = "F12367",
                        ...
                        new
                        {
                            ...
                            CurrentStatus = "Airworthy",
                            Cycles = 800,
                            LastUpdated = new DateTime(2024, 11, 22, 5, 48, 7, 434, DateTimeKind.Utc).AddTicks(9744),
                            Model = "Embraer E190",
                            Registration = "H89012",
                        ...
                        new
                        {
                            ...
                            CurrentStatus = "Airworthy",
                            Cycles = 300,
                            LastUpdated = new DateTime(2024, 11, 22, 5, 48, 7, 434, DateTimeKind.Utc).AddTicks(9747),
                            Model = "Cessna 172",
                            Registration = "I34567",
